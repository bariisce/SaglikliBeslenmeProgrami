    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "İlaç Alerjisi", new DateTime(2024, 10, 2, 22, 13, 1, 800, DateTimeKind.Utc).AddTicks(8378), "Kaşıntı, Kurdeşen, Döküntü, Yüzün Şişmesi", false, null });

            migrationBuilder.InsertData(
                table: "MealCategories",
                columns: new[] { "Id", "CategoryName", "CreatedAt", "Description", "IsDeleted", "UpdatedAt" },
                values: new object[] { 1, "Deniz Yemekleri", new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(2268), "b12 ve demir eksikliği olanlar için", false, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(4374), false, "Admin", null },
                    { 2, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(4378), false, "Dietitian", null },
                    { 3, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(4382), false, "Patient", null }
                });

            migrationBuilder.InsertData(
                table: "Meals",
                columns: new[] { "Id", "Calory", "Carbonhydrate", "CategoryId", "CreatedAt", "Description", "Fat", "Image", "IsDeleted", "MealName", "Protein", "UpdatedAt" },
                values: new object[] { 1, 99m, "10 g", 1, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(2688), "Tiroit hastaları için deniz yemeği", "20 g", "1.jpg", false, "Karides", "50 g", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 22, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(4827), "barisceylan907@gmail.com", "Erkek", false, "Barış", "baris.C123", "05305137988", 2, "Ceylan", null, "barisscl" },
                    { 2, 21, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(4832), "hakantemiz@gmail.com", "Erkek", false, "Hakan", "hakan.123H", "053087347821", 3, "Temiz", null, "hakaaannn.11" }
                });

            migrationBuilder.InsertData(
                table: "Dietitians",
                columns: new[] { "Id", "CreatedAt", "ExperienceYears", "IsActive", "IsDeleted", "Specialization", "UpdatedAt", "UserId" },
                values: new object[] { 1, new DateTime(2024, 10, 2, 22, 13, 1, 800, DateTimeKind.Utc).AddTicks(8996), 1, true, false, "Diyabet Diyetisyeni", null, 1 });

            migrationBuilder.InsertData(
                table: "MealRecipes",
                columns: new[] { "Id", "CookingTime", "CreatedAt", "Ingredients", "Instructions", "IsDeleted", "MealId", "PreparationTime", "UpdatedAt" },
                values: new object[] { 1, "20 dakika", new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(3161), "Yarım kilo temizlenmiş ve dondurulmuş karides, 3 diş sarımsak, 6 yemek kaşığı zeytinyağı, 1 çay kaşığı pul biber, 1 çay kaşığı toz kırmızı biber (olmasa da olur), 1 çay kaşığından az karabiber, 1 çay kaşığı tuz, 3 yemek kaşığı limon suyu", "Yemeği Yapma Adımları", false, 1, "30 dakika", null });

            migrationBuilder.InsertData(
                table: "Patients",
                columns: new[] { "Id", "CreatedAt", "Height", "IsDeleted", "MedicalConditions", "Medications", "UpdatedAt", "UserId", "Weight" },
                values: new object[] { 1, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(3998), 178f, false, "Tiroid Hastalığı", "Levotiron, Tefor, Euthyrox", null, 2, 70f });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 200, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(1036), "Tiroit hastalığından dolayı alman gereken kalori miktarına dikkat etmelisin !", "Kilo Verme Programı", 1, "2025-06-10", false, 1, "2024-11-11", true, null });

            migrationBuilder.InsertData(
                table: "HealthRecords",
                columns: new[] { "Id", "BloodPressure", "BloodSugar", "Cholesterol", "CreatedAt", "HeartRate", "IsDeleted", "PatientId", "RecordedDate", "UpdatedAt" },
                values: new object[] { 1, 120m, 150m, 239m, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(1876), 90m, false, 1, "2024-12-08", null });

            migrationBuilder.InsertData(
                table: "PatientAllergies",
                columns: new[] { "Id", "AllergyId", "CreatedAt", "IsDeleted", "PatientId", "ReactionDescription", "Severity", "UpdatedAt" },
                values: new object[] { 1, 1, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(3556), false, 1, "Ansiyete ve sinirlilik hali", "Yüksek", null });

            migrationBuilder.InsertData(
                table: "DietPlanMeals",
                columns: new[] { "Id", "CreatedAt", "DietPlanId", "IsDeleted", "MealId", "ServingSize", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2024, 10, 2, 22, 13, 1, 801, DateTimeKind.Utc).AddTicks(1477), 1, false, 1, 2, null });

            migrationBuilder.InsertData(
                table: "DietitianPatients",
                columns: new[] { "Id", "CreatedAt", "DietPlanId", "DietitianId", "IsDeleted", "PatientId", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2024, 10, 2, 22, 13, 1, 800, DateTimeKind.Utc).AddTicks(9392), 1, 1, false, 1, null });
